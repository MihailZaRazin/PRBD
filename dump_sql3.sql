...
--
-- Host: 172.16.7.85    Database: razin_univer
-- ------------------------------------------------------
...
INSERT INTO `student_has_emploee` VALUES (1,1,10,'2024-06-15','зачтено'),(1,1,11,'2024-06-15','зачтено'),(1,2,5,'2024-04-20','зачтено'),(1,3,1,'2024-03-18','зачтено'),(1,4,3,'2024-03-15','зачтено'),(1,5,1,'2024-05-25','зачтено'),(1,6,6,'2024-03-15','зачтено'),(1,7,7,'2024-04-07','зачтено'),(1,8,9,'2024-05-01','зачтено'),(1,9,5,'2024-05-11','зачтено'),(1,10,8,'2024-03-19','зачтено'),(2,2,5,'2024-04-20','не явился'),(2,3,1,'2024-03-18','зачтено'),(2,4,3,'2024-03-15','зачтено'),(3,2,5,'2024-04-20','не явился'),(3,3,1,'2024-03-18','зачтено'),(3,4,3,'2024-03-15','не явился'),(4,2,5,'2024-04-20','не явился'),(4,3,1,'2024-03-18','зачтено'),(4,4,3,'2024-03-15','зачтено'),(5,4,3,'2024-03-15','не явился'),(5,6,6,'2024-03-15','зачтено'),(5,8,9,'2024-05-01','не явился'),(6,4,3,'2024-03-15','зачтено'),(6,6,6,'2024-03-15','не явился'),(6,8,9,'2024-05-01','зачтено'),(7,4,3,'2024-03-15','зачтено'),(7,6,6,'2024-03-15','зачтено'),(7,8,9,'2024-05-01','зачтено'),(8,4,3,'2024-03-15','не явился'),(9,4,3,'2024-03-15','не явился'),(10,4,3,'2024-03-15','не явился'),(10,5,1,'2024-05-25','не явился'),(10,6,6,'2024-03-15','не явился'),(10,7,7,'2024-04-07','зачтено'),(10,8,9,'2024-05-01','не явился');
...
-- Dump completed on 2024-10-02 10:41:29
